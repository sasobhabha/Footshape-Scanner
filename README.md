...
Footshape Scanner is an iOS application that allows users to scan their feet using an iOS device (FaceID / TrueDepth / LiDAR enabled) and generate accurate 3D models. Users can capture precise 3D dimensions of feet for podiatry, custom orthotics, ergonomic shoe fitting, and bespoke footwear. 
